export const Item = ({ id, name, completed, listId, setCompleted, index, deleteItem }) => {
    ...
    return (
        <li className="list-group-item" key={index}>
            ...
            <input className="form-check-input p-6"
                ...
                readOnly={true} />
                <button className="btn btn-danger ml-auto" onClick={() => deleteItem(listId, id)}>{trash}</button>
        </li>
    )
}